...
public class StepImplementation {
    ...
    @Step({"<key> indirimli fiyatı toplam <expectedText> fiyatına <element> dahil eşit mi",
            "get text <key> element and control <expectedText> with cargo price <element>"})
    public void controlElementTextsWithKargoPrice(String key, String value, String element) {
        methods.controlPrice(key,value,element);
    }
