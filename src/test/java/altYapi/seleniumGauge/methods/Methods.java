...
import static altYapi.seleniumGauge.step.StepImplementation.clearTurkishChars;
import static altYapi.seleniumGauge.step.StepImplementation.round;
...
public class Methods {
    ...
    public void waitPageLoadCompleteJs() {
        ...
        jsMethods.waitPageLoadComplete(setFluentWait(30));
    }
    ...
    public void ifVisibleSelectRandom(String key, String element){
        if (isElementVisible(getBy(key),1)){
            ...
            logger.info("Renk seçimi yapıldı");
        }
        else{
            logger.info("Renk seçeneği bulunmamaktadır.");
        }}

    public void controlPrice(String key, String value, String element) {
        ...
        if ("UCRETSIZ".compareTo(cargoPrice) == 0) {
            ...
            System.out.println("Alınan text: " + round(fActualNew,2));
    ...
    public void removeProductIsVisible(String key, String element){
        if (isElementVisible(getBy(key),1)){
            ...
            logger.info("Sepette farklı çeşitte bulunan ürün silindi.");
        }
        else {
            logger.info("Sepette sadece 1 çeşit ürün bulunmaktadır.");
            waitByMilliSeconds(50);
        }
    }
}
